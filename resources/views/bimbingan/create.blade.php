                    ...
                    <form method="POST" action="{{route('bimbingan.store')}}">
                        ...
                        <div class="form-group">
                          <label for="nim"><strong> NIM </strong></label>
                            <input type="text" name="nim" value="{{old('nim')}}" placeholder="Masukkan NIM anda " class="form-control @error('nim') is-invalid @enderror"  id="nim" >
                                @error('nim')
                        ...
                        <div class="form-group">
                          <label for="namaLengkap"><strong> Nama  Lengkap </strong></label>
                            <input type="text" name="namaLengkap" value="{{old('namaLengkap')}}" placeholder="Masukkan Nama Lengkap anda "  class="form-control @error('namaLengkap') is-invalid @enderror"  id="namaLengkap" >
                              @error('namaLengkap')
                                <div class="invalid-feedback">
                                  {{$message}}
                                </div>
