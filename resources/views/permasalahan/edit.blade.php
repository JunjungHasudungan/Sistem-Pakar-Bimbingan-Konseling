  ...
  <div class="container">
            <div class="card mt-5">
                <div class="card-header text-left">
                    <strong>Edit Data Permasalahan</strong>
                </div>
                <div class="card-body">
                      ...
                      @method('PUT')
                        ...
                        <div class="form-group">
                            <label for="keteranganPermasalahan"><strong> Keterangan Permasalahan</strong></label>
                                <input type="text" name="keteranganPermasalahan" value="{{ $permasalahan->keteranganPermasalahan }}" class="form-control @error('keteranganPermasalahan') is-invalid @enderror"  id="keteranganPermasalahan" >
